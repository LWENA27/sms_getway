-- Emergency fix: Drop everything and rebuild cleanly

-- Drop the problematic trigger completely
DROP TRIGGER IF EXISTS "set_updated_at_sms_requests" ON "sms_gateway"."sms_requests" CASCADE;

-- Drop the trigger function
DROP FUNCTION IF EXISTS "sms_gateway"."update_updated_at_column"() CASCADE;

-- Recreate just the two API functions without any triggers interfering
